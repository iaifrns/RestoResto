...
const FooterSection = () => {
  ...
  return (
    <div className="w-full" id="footer">
      <ComponentContainer extraStyle="flex flex-col justify-center items-center gap-8">
        <div className="flex gap-8 flex-col w-[85%]">
          <div className="w-full flex justify-between">
            <div className="flex gap-8 items-center">
              ...
              <div className="flex gap-2 items-center font-playfair">
        ...
        <div className="w-full bg-[rgba(24,24,24)] flex justify-center items-center">
          <div className="w-[85%] flex justify-between items-center p-8">
            ...
            <a href="#landing" className="text-secondary text-sm font-playfair">Back To Top</a>
          </div>
        </div>
      </ComponentContainer>
    </div>
